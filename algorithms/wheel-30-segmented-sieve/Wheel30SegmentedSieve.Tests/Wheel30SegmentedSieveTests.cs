...
namespace Wheel30SegmentedSieve.Tests;

public class Wheel30SegmentedSieveTests
{
    private readonly IPrimeChecker _checker = new Wheel30SegmentedSievePrimeChecker();
