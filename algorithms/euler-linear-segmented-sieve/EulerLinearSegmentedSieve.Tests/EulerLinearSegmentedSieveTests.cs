...
namespace EulerLinearSegmentedSieve.Tests;

public class EulerLinearSegmentedSieveTests
{
    private readonly IPrimeChecker _checker = new EulerLinearSegmentedSievePrimeChecker();
