...
namespace BitwiseSegmentedSieve.Tests;

public class BitwiseSegmentedSieveTests
{
    private readonly IPrimeChecker _checker = new BitwiseSegmentedSievePrimeChecker();
